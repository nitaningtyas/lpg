        ...
        <section class="content">
          ...
          <div class="row">
            <div class="col-sm-5">
              <div class="box box-success">
                <div class="box-header with-border">
                  <h3 class="box-title">Tambah Kategori Pangkalan</h3>
                </div>
                <!-- /.box-header -->
                ...
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <input name="nama" type="text" class="form-control" placeholder="Nama Pangkalan" required="">
                  </div>
                  <div class="form-group">
            ...
            <div class="col-md-7">
              <div class="box box-success">
                <div class="box-header with-border">
                  <h3 class="box-title">Daftar Kategori Pangkalan</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
