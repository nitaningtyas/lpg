          ...
          <div class="row">
            ...
            <?=form_open('dashboard/lokasi') ?>
			  ...
			  <div class="form-group">
                  ...
                  <input name="pangkalan" type="text" class="form-control" value="<?=$l['pangkalan'] ?>">
                </div>
                <div class="form-group">
				 ...
				 <div class="form-group">
                  ...
                  <input name="no_reg" type="text" class="form-control" value="<?=$l['no_reg'] ?>">
                </div>
				 <div class="form-group">
                  <label>KTP</label>                  
                  <input name="ktp" type="text" class="form-control" value="<?=$l['ktp'] ?>">
                </div>
				 <div class="form-group">
                  <label>Jumlah Tabung</label>                  
                  <input name="jml_tabung" type="text" class="form-control" value="<?=$l['jml_tabung'] ?>">
                </div>
                <div class="form-group">
